...
Exploring and engineering evolutionary chromatin design
======
Organisms are capable of surviving at extreme conditions and sustaining intense physiological stressors; however, the mechanisms that underlie the responses and resiliency of the genome to these harsh conditions are poorly understood. Characterizing the molecular components of these mechanisms and how they have evolved to achieve their specialized functions would expand our understanding of cellular evolution and the fundamental rules underlying chromatin and gene regulation. It would also allow us to engineer chromatin for a vast range of therapeutic and bioengineering applications. Using a platform for the systematic, high-throughput functional, spatial, and genomic characterization of chromatin-associated proteins developed in my postdoctoral work, I am systematically defining chromatin design rules, map how these rules have evolved and diversified over time, and use these insights, combined with computational protein design, to create novel protein components that can be used to bolster resilience in human and plant cells. This work will drive forward our understanding of molecular evolution, unveil fundamental physical mechanisms underlying genome organization, and inform the design and engineering of genomes for a broad range of cellular applications, including cryotherapies, tissue preservation, and environmentally resilient plants.
